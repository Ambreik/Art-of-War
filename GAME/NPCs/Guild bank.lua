...
- Access Location :   
  ...
  - Players can only access it within the boundaries of their guild’s territory or headquarters.
...
- Item Storage :   
  ...
  - Permissions can be set up for different guild ranks, restricting access per page (e.g., some members may only have access to certain pages for depositing/withdrawing).
  
	4. Permission System
- Advanced Permission Control :   
  - The guild master can configure permissions for each page, specifying who can interact with the bank and what actions they can perform (deposit or withdraw items or money).
  - Permissions can be set per page or per guild rank. Specific guild ranks can have different access rights (e.g., higher-ranked members may have broader access).
