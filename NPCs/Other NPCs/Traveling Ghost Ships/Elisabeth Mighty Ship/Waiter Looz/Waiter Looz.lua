...
jot down orders with a flourish.
	As he navigates the saloon, "Looz" possesses an uncanny ability to remember patrons’ preferences, ensuring that regulars always have their favorite beverages 
ready. He is known for his friendly banter and playful jests, making every visit to the saloon a delightful experience.
...
character is about to become typsy, the screen turns black for 3 seconds. This can continue to happen if the character is still typsy until puke. end 
	...
	With his engaging personality and extensive beverage menu, "Waiter Looz" ensures that every moment spent in the saloon is enjoyable, leaving a lasting 
impression on all who cross his path.

	
		Mechanics : 
	He is a SHOP NPC and skillable NPC inside the saloon. 
	He have a high "Movement Speed".
	If he can be lured outside the saloon without the "Guardians" to be aware, you can have fight with him and defeated, he will give you his special drinks for 
free. To lure him, player must use "Sticky Spice Carrots" and to counter his highly "Movement Speed" by affecting him with "Slowdown".