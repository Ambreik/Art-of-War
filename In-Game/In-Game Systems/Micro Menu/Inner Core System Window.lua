...
*The refinement can fail, in this case "Soul Core" level is reduced by or remains unchanged.
	In the window of level upgrade, need to put your "Soul Core" in the appropriate slots and an "Energy Orb" and click “refine”. If success, the result is crafted in 
the left side empty slot with a : 
