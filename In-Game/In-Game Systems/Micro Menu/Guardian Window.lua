...
*Movement Speed : total value of Movement Speed that the "Guardian" have it.
*Attack Speed : total value of Attack Speed that the "Guardian" have it.
*Casting Speed : total value of Casting Speed that the "Guardian" have it.
*Attack Value : total value of physical damage that the "Guardian" have it with two values as "Min" and "Max" value.
*Defence (ACC) : total physical defence that the "Guardian" have it.
*Magic Attack Value: total value of magic damage that the "Guardian" have it with two values as "Min" and "Max" value.
*Magic Defence : total magic defence that the "Guardian" have it.
*Evasion : represent the % of the evasion that the "Guardian" have it. This include all hits from ranged attacks.
*Rage : value of the current "Rage" that the "Guardian" have it.
*Stamina : value of the currencies "Stamina" that the "Guardian" have it.
...
the current other bonuses that the character have it on items at the moment.
		...
		Second Page : 
	Tab one : Skills : 
	Here are all "Guardian" skills that can be learned,in two grouped lists.
	Tab two : Talents : 
	This is where all the talents are found and can be edited using points earned when "Guardian" level up. 
		
		Third Page : 
	This page is dedicated to the equipment inventory specific to the "Guardian". It is similar to the player equipment inventory and contains in this interface, 
...
armor and hairstyles.
	"Guardian" have no inventory to store items. All his extra items are stored in character inventory.
...
*Dismiss Guardian : 
*Feed Guardian : 
	After this 3 bottons, is an entire list of emotes that your "Guardian" can do. List can be scrolled down using the scroll from the right side.